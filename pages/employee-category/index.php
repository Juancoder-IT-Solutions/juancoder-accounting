...
<script type="text/javascript">
    ...
    function getEntries() {
        ...
        $("#dt_entries").DataTable({
            ...
            {
                "mRender": function(data, type, row) {
                    return "<div style='display:flex;align-items:center'><button class='btn btn-primary btn-circle mr-1' onclick='getEntryDetails(" + row.id + ")' style='padding:15px';height='45px;'><span class='ti ti-pencil'></span></button></div>";
                }
            },
            {
                "data": "category_name"
