     ...
     <div class="modal-dialog  modal-lg" style="margin-top: 50px;" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body" style="padding: 15px;">
                 <input type="hidden" id="hidden_id_cp" name="input[cp_id]">
                 <div class="col-12" id="print_canvas">
                     ...
                     <strong>Date: </strong><span id="payment_date_span"></span><br>
     ...
     function printRecord(id) {
         ...
         $.ajax({
             ...
             success: function(data) {
                 ...
                 $("#payment_date_span").html(json.data[0].payment_date_mod);
                 $("#remarks_span").html(json.data[0].remarks);

                 getPrintDetails(json.data[0].cp_id);
             }
         });
     }
